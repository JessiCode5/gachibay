...
/datum/job/clown
	title = "Jabroni"
	supervisors = "none other than the Big Jabroni himself."
	minimal_player_age = 14
	economic_modifier = 1
	ideal_character_age = 21
	alt_titles = null
	...
	equip(var/mob/living/carbon/human/H)
		..()
		H.add_stats(rand(1,20), rand(1,20), rand(1,20))



/datum/job/prostitute
	title = "Performance Artist"
	supervisors = "anyone (and anything) that pays you enough. But Billy always comes first."
	minimal_player_age = 14
	economic_modifier = 1
	ideal_character_age = 21
	alt_titles = null
	...
	equip(var/mob/living/carbon/human/H)
		..()
		H.add_stats(rand(6,9), rand(9,11), rand(7,10))
