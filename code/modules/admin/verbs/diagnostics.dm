...
/client/proc/reload_shunned()
	set name = "Reload Shunned"
	set category = "Debug"

	if(!check_rights(R_SERVER))	return

	message_admins("[usr] manually reloaded the shunned list!")
	load_shunned()
	//feedback_add_details("admin_verb","RLDSL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
