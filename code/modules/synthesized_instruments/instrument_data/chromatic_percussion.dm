...
/datum/instrument/chromatic/vibraphone1
	...
	id = "crvibr"
	samples = list("36"='code/modules/synthesized_instruments/samples/chromatic/vibraphone1/c2.ogg',
				   "48"='code/modules/synthesized_instruments/samples/chromatic/vibraphone1/c3.ogg',
				   "60"='code/modules/synthesized_instruments/samples/chromatic/vibraphone1/c4.ogg',
				   "72"='code/modules/synthesized_instruments/samples/chromatic/vibraphone1/c5.ogg')

/datum/instrument/chromatic/musicbox1
	name = "SGM Music Box"
	id = "sgmmbox"
	samples = list("36"='code/modules/synthesized_instruments/samples/chromatic/sgmbox/c2.ogg',
				   "48"='code/modules/synthesized_instruments/samples/chromatic/sgmbox/c3.ogg',
				   "60"='code/modules/synthesized_instruments/samples/chromatic/sgmbox/c4.ogg',
				   "72"='code/modules/synthesized_instruments/samples/chromatic/sgmbox/c5.ogg')
