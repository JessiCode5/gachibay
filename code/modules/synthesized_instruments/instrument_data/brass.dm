...
/datum/instrument/brass/crisis_section
	...
	id = "crbrass"
	samples = list("36"='code/modules/synthesized_instruments/samples/brass/crisis_brass/c2.ogg',
				   "48"='code/modules/synthesized_instruments/samples/brass/crisis_brass/c3.ogg',
				   "60"='code/modules/synthesized_instruments/samples/brass/crisis_brass/c4.ogg',
				   "72"='code/modules/synthesized_instruments/samples/brass/crisis_brass/c5.ogg')
