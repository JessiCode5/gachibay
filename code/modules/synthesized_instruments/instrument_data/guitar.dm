...
/datum/instrument/guitar/steel_crisis
	...
	id = "csteelgt"
	samples = list("36"='code/modules/synthesized_instruments/samples/guitar/crisis_steel/c2.ogg',
				   "48"='code/modules/synthesized_instruments/samples/guitar/crisis_steel/c3.ogg',
				   "60"='code/modules/synthesized_instruments/samples/guitar/crisis_steel/c4.ogg',
				   "72"='code/modules/synthesized_instruments/samples/guitar/crisis_steel/c5.ogg')

/datum/instrument/guitar/nylon_crisis
	name = "Crisis Nylon String Guitar"
	id = "cnylongt"
	samples = list("36"='code/modules/synthesized_instruments/samples/guitar/crisis_nylon/c2.ogg',
				   "48"='code/modules/synthesized_instruments/samples/guitar/crisis_nylon/c3.ogg',
				   "60"='code/modules/synthesized_instruments/samples/guitar/crisis_nylon/c4.ogg',
				   "72"='code/modules/synthesized_instruments/samples/guitar/crisis_nylon/c5.ogg')
